...
/**
 * Persisted whiteboard surface state: the pan offset of the infinite canvas and
 * every freehand stroke drawn on it. Kept separate from the widget layout so the
 * two concerns evolve (and version) independently.
 */

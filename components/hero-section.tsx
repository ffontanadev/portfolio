...
export const HeroSection = () => {
    ...
    return (
        ...
        >
            {/* Placeholder for animated code showcase - will be added in Phase 4 */}
                        ...
                        <div className="mt-8 flex flex-col sm:flex-row items-start sm:items-center gap-4">
                            <Tooltip content="Explora proyectos interactivos" position="top">
                                <Button
                                    ...
                                    className="border-white/30 text-[#f97316] hover:bg-white hover:text-black px-8 py-6 rounded-full transition-all duration-300"
                                >
                            ...
                            <a href={whatsappHref} target="_blank" rel="noreferrer">
                                <Button
                                    size="lg"
                                    className="bg-[#f97316] hover:bg-white text-white hover:text-black font-semibold px-8 py-6 rounded-full transition-all duration-300 hover:shadow-lg hover:shadow-[#f97316]/25 hover:scale-105"
